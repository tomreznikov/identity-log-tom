...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(GroupingStepComponent, [{
        ...
        value: function init(width, height, newRadius, data) {
          ...
          var node3 = svg.selectAll('.draggableText').data(data).enter().append('g').append('text').attr('id', function (d, i) {
            ...
            return d.y ? d.y : height / 2;
          }).attr('text-anchor', 'middle').style('font-size', 25 + 'px').style('cursor', 'pointer').on('mouseover', handleMouseOver).on('mouseout', handleMouseOut).text(function (d) {
            return d.name;
          });
          var g = svg.selectAll('g');
          var simulation = d3.forceSimulation().force("forceX", d3.forceX().strength(.002).x(width * .5)).force("forceY", d3.forceY().strength(.09).y(height * .5)).force("center", d3.forceCenter().x(width * .5).y(height * .5)).force("charge", d3.forceManyBody().strength(-60));
          initSimulation(true);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/tomreznikov2/Documents/GitHub/identity-log/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
